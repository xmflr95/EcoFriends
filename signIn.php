...
<body class="w3-content" style="max-width: 100vw">
   ...
   <div class="w3-main" id="mainContent">
      ...
      <!-- Image header -->
      <div class="w3-display-container w3-container w3-margin-bottom w3-mobile" id="loginBox">
      <?php if(!isset($_SESSION['email']) || !isset($_SESSION['username'])) { ?>
         <form class="w3-container" action="signIn_ok.php" method="POST">
         ...
         <?php
            ...
            $uses_name = $_SESSION['username'];
            echo "<p><b>$uses_name</b>($user_id)님은 이미 로그인 하고 있습니다. <br>";
